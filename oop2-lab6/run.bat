@echo off
REM Скрипт для запуска лабораторной работы №6 в Windows

echo ================================================
echo Лабораторная работа №6: Взаимодействие акторов
echo ================================================
echo.
...
echo ================================================
echo.
call mvn exec:java -Dexec.mainClass="com.akka.lab6.Main" -q

echo.
echo.
echo 📝 Хотите запустить дополнительные эксперименты?
echo Используйте команду:
echo   mvn exec:java -Dexec.mainClass="com.akka.lab6.ExperimentsMain"
echo.
